...
import com.gk969.gallery.gallery3d.app.GalleryApp;
import com.gk969.gallery.gallery3d.data.BucketHelper.BucketEntry;
import com.gk969.gallery.gallery3d.util.Future;
import com.gk969.gallery.gallery3d.util.FutureListener;
...
public class LocalAlbumSet extends MediaSet
    ...
    public LocalAlbumSet(Path path, GalleryApp application) {
        ...
        mName = "set_label_local_albums";

        Log.i(TAG, "LocalAlbumSet "+path.toString()+" name:"+mName);
    }
    ...
    public MediaSet getSubMediaSet(int index) {
        MediaSet subSet=mAlbums.get(index);
        Log.i(TAG, "getSubMediaSet:"+subSet.getName());
        return subSet;
    }
        ...
        public ArrayList<MediaSet> run(JobContext jc) {
            ...
            */
            ...
            for (BucketEntry entry : entries) {
                ...
                Log.i(TAG, "AlbumsLoader "+album.getName());
                albums.add(album);
            }
            return albums;
        }
